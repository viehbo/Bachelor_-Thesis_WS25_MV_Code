...
\title{glaciVis}
\subtitle{Interactive Visual Exploration of ERA5 Data for Glacier Research}
...
\supervisor[Erstbetreuer]{Univ.-Prof. DI Dr. Marc Streit}
\supervisor[Zweitbetreuer]{DI Dr. Andreas Hinterreiter}
\supervisor[Zweitbetreuer]{DI Dr. Christina Humer}
...
%%\include{frontmatter/abstract-de}
...
\include{03-solution}
\include{04-use-case}
\include{reports/Thesis Report/05-discussion}
\include{reports/Thesis Report/06-conclusion}
