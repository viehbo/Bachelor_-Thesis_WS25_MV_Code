...
The objective is now to find a way how data from ERA5 can be discovered in an efficient and intuitive way.
This project is based on the work from \textit{Practical Work in AI (364055,2024W)} which I have done in winter semester 2024. Many insights have accelerated the progress of this thesis project and led to a more appropriate approach to data processing and presentation.
Due to the huge amount of data and the complexity, 
